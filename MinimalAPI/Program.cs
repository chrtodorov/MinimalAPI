...
var com = builder.Configuration.GetConnectionString("CommandDb");
//sqlConBuilder.UserID = builder.Configuration["UserId"];
//sqlConBuilder.Password = builder.Configuration["Password"];

var conn = "Server=localhost,1433;Database=CommandDb;User Id=sa;Password=pa55w0rd!;";
...
app.MapDelete("app/v1/commands/{id}", async (ICommandRepo repo, IMapper mapper, int id) =>
{
    var command = await repo.GetCommandById(id);
    if (command is null)
    {
